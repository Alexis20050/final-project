<x-app-layout>
    ...
    <style>
        ...
        .tips{}
        .tip{display:flex;gap:10px;padding:13px 16px;border-bottom:1px solid var(--border);align-items:flex-start;}
        .tip:last-child{border-bottom:none;}
        .tip-ic{width:28px;height:28px;border-radius:7px;background:var(--surface-2);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;}
    ...
    <div class="fl">
                ...
                <div class="fb">
                    ...
                    <div class="row2">
                        <div class="field">
                            ...
                            <input id="room_number" type="text" name="room_number" value="{{ old('room_number') }}" placeholder="e.g. 101, A-04" class="fl-input" required autofocus>
                    ...
                    <div class="row2">
                        <div class="field">
                            ...
                            <div class="fl-prefix">
                                ...
                                <input id="price_per_month" type="number" step="0.01" min="0" name="price_per_month" value="{{ old('price_per_month') }}" placeholder="0.00" class="fl-input" required>
                            </div>
        ...
        <div class="card">
            <div style="padding:12px 16px;border-bottom:1px solid var(--border);">
                <p style="font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.07em;color:var(--text-3);margin:0;">Room Setup Tips</p>
            </div>
            <div class="tips">
                <div class="tip">
                    ...
                    <div><div class="tip-ttl">Consistent numbering</div><div class="tip-desc">Use a clear format like Floor-Room (e.g. 1-01, 3-12) for easy identification.</div></div>
                </div>
                <div class="tip">
                    ...
                    <div><div class="tip-ttl">Fair pricing</div><div class="tip-desc">Review local market rates before setting your monthly price.</div></div>
                </div>
                <div class="tip">
                    ...
                    <div><div class="tip-ttl">Start Available</div><div class="tip-desc">New rooms should start as Available unless already occupied.</div></div>
                </div>
            </div>
        </div>
    </div>
