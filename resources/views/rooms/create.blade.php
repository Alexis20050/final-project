<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add New Room</h2>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('rooms.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="price_per_month" class="block mt-1 w-full" type="number" step="0.01" name="price_per_month" :value="old('price_per_month')" required />
